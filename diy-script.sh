...
git_sparse_clone main https://github.com/kenzok8/small-package/luci-app-dnscrypt-proxy2 package/luci-app-dnscrypt-proxy2
...
git_sparse_clone main https://github.com/xiaorouji/openwrt-passwall-packages/shadowsocks-rust package/small/shadowsocks-rust

## Add deps(from other source)
git_sparse_clone main https://github.com/coolsnowwolf/lede/trunk/package/lean/libcryptopp package/libcryptopp
