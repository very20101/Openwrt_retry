...
git clone https://github.com/very20101/small-package-uf.git smpackage
...
cp -rf packages/op-retry/pkg_modified/luci-app-fileassistant feeds/smpackage/luci-app-fileassistant
